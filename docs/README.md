...
모든 Markdown 문서는 `/home/tempchian-1/바탕화면/erp-wbs/docs/` 폴더에서 관리합니다. [WBS 현황판](../index.html)은 `대시보드`와 `상세사항` 두 탭에서 진행률 기준선과 업무 범위를 보여줍니다. 문서는 아래 링크에서 별도로 열람합니다.
...
- 금융·회계는 구축 범위에서 제외합니다. 2026-09-23에 요청된 생산부·사업부·기술개발부 세부 기능은 WBS 초안에 반영했으며, 부서별 회의·요구사항·수용 기준 확인 후 확정합니다.
